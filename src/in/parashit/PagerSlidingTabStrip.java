...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabActiveTextColor = context.getResources().getColor(R.color.ps_tab_text_color);
        tabInactiveTextColor = context.getResources().getColor(R.color.ps_tab_inactive_text_color);
        int PrimaryColor = context.getResources().getColor(R.color.ps_tab_color);
